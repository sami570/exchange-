...
<div class="col-sm-9">
<input type="text" class="form-control @error('slide_title') is-invalid @enderror" name="slide_title" value="{{ $slide->slide_title}}" id="slideTitle" placeholder="Write slide title here" >
@error('slide_title')
<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
@enderror
</div>
...
<div class="col-sm-9">
<input type="text" class="form-control @error('slide_description') is-invalid @enderror" name="slide_description" id="slideDescription" placeholder="Write slide description here" value="{{ $slide->slide_description}}" >
...
<input class="form-check-input" type="radio" name="publication_status" value="1" {{$slide->publication_status ==1 ?'checked':''}} >
<label class="form-check-label">Published</label>
</div>
<div class="form-check col-form-label">
<input class="form-check-input" type="radio" name="status" value="2"  {{$slide->publication_status ==2 ?'checked':''}}  >
